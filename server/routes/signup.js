...
router.post('/', (req, res) => {
    ...
    if (
        ...
        if (nickname != 'user' && nickname !=  'api' && nickname !=  'admin' && nickname !=  'setting') {
                                            ...
                                            <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                                        ...
                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi there, Thank you for signing up to <a style="font-family:'Pattaya', sans-serif; text-decoration:none; color:#161616;" href="#" >morningti.me</a></p>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                                    ...
                                                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                                                        <div>
                                                            <a href="https://www.morningti.me" style="font-family:'Pattaya', sans-serif; color: #999999; font-size: 18px; text-align: center;' text-decoration:none;">morningti.me</a>
                                                        </div>
                                                            <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">address, country</span>
                                                        <div>
                                                            <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">office.morningti.me</span>
                                                        </div>
